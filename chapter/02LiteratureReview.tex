...
% ------------------------- 2.0 ------------------------- %
本論文研究主題為探討如何利用 IMU 提升人體姿態量測、估計與重建的成功率，並降低其使用門檻。因此，本章節將針對人體姿態估計的相關文獻進行回顧與討論，內容包括動作捕捉系統及相關感測器的應用、人體模型種類、時間對齊方法、感測器融合演算法等，統整現今常見技術，並說明其原理、特色、目前可達到的精度、優缺點等，以作為本研究之基礎。
