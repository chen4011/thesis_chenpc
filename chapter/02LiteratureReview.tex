...
由 Google 團隊開發的 MediaPipe ~\cite{mediapipe_web} 及由 Microsoft 開發的 Kinect ~\cite{zhang2012microsoft} 等系統是目前常見的無標記動作捕捉系統，常被應用於重建人體姿態，或是估計關節角度~\cite{LATRECHE2023112826}，
