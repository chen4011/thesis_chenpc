...
資料前處理分為人體骨架建立、時間軸對齊、
IMU - 全域座標轉換矩陣計算、IMU - 骨架座標轉換矩陣計算，等四個章節，
將於下列四小章節進行討論。
...
結果如表 \ref{ch3_skeleton_compare} 所示，可以發現自行建立之骨架之四肢長度與 Vicon 骨架之四肢長度相當接近，
因此證明本方法的可行性。
\begin{table}[!ht]
   \caption[骨架建立結果與驗證]{骨架建立結果與驗證}
   \centering
   ...
   \begin{tabular}{c|c|c|c|c}
      & 左上臂 & 左下臂 & 右上臂 & 右下臂 \\
      \midrule
      Vicon 骨架 & 0.0000 & 0.0000 & 肘關節 & 0.0000 \\
      自行建立骨架 & 0.0000 & 0.0000 & 手腕關節 & 0.0000 \\
      \hline\hline
      & 左大腿 & 左小腿 & 右大腿 & 右小腿 \\
      \midrule
      Vicon 骨架 & 0.0000 & 0.0000 & 膝關節 & 0.0000 \\
      自行建立骨架 & 0.0000 & 0.0000 & 踝關節 & 0.0000 \\
   \end{tabular}}
\end{table}
...
\subsection{IMU - 全域座標旋轉矩陣計算}
% IMU - 全域座標轉換矩陣計算介紹
$R_{ig}$

\subsection{IMU - 骨架座標旋轉矩陣計算}
% IMU - 骨架座標轉換矩陣計算介紹
$R_{ib}$
